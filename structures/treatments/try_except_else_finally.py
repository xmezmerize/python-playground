...
try:
   num = int(input('Informe um número: '))
    ...
    print(f'Você digitou {num}') # -> o else é executado somente se não der erro
"""
# =================================================================================================================== #
"""
# Finally
...
try:
    ...
    print('Executando o finally') # -> o finally é sempre executado, dando fim ao fluxo da estrutura
    # O finally, geralmente, é utilizado para fechar ou deslocar recursos.
"""
# =================================================================================================================== #
"""
# Exemplo mais complexo ERRADO -> faço a função antes do tratamento
...
# =================================================================================================================== #
"""
# Exemplo mais complexo CORRETO -> tratamento feito nas entradas da função
